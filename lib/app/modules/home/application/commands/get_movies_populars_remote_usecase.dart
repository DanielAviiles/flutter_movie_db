...
@injectable
class GetMoviesPopularsRemoteUsecase
    extends Command<Either<Failure, List<MovieModel>>, PropertiesMovieUseCase> {
  GetMoviesPopularsRemoteUsecase(this.getMovieRepository);
  final GetMovieRepository getMovieRepository;

  @override
  Future<Either<Failure, List<MovieModel>>?> execute(PropertiesMovieUseCase params) async {
